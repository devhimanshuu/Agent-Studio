      ...
      <body className={inter.className}>
        <ClerkProvider
          appearance={{
            ...
            variables: {
              colorPrimary: "#818cf8",
              colorBackground: "#060813",
              colorText: "#e2e8f0",
              colorTextSecondary: "#94a3b8",
              colorInputBackground: "#080b1a",
              colorInputText: "#ffffff",
              fontFamily: "JetBrains Mono, monospace",
              borderRadius: "0.25rem",
            },
            elements: {
              card: "border border-indigo-900/50 bg-[#060813] font-mono shadow-2xl shadow-indigo-950/80 rounded",
              ...
              formFieldInput: "border border-indigo-900/50 bg-[#080b1a] font-mono text-xs text-slate-100 focus:border-indigo-400 rounded",
              ...
              userButtonPopoverCard: "border border-indigo-900/50 bg-[#060813] font-mono shadow-xl rounded",
