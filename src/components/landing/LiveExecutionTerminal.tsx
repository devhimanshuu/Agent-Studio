...
export function LiveExecutionTerminal() {
  ...
  return (
    <div className="rounded border border-slate-200 dark:border-indigo-900/50 bg-white/90 dark:bg-black font-mono shadow-xl dark:shadow-2xl shadow-indigo-500/10 dark:shadow-indigo-950/50 overflow-hidden transition-all duration-200">
      {/* Terminal Bar */}
      <div className="px-4 py-2.5 bg-slate-100/90 dark:bg-[#0a0a0a] border-b border-slate-200 dark:border-indigo-950 flex items-center justify-between gap-2 text-xs">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-slate-600 dark:text-slate-400 text-[11px] font-mono flex items-center gap-1.5 ml-2 truncate font-medium">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {!isRunning ? (
            <button
              ...
              className="px-2.5 py-1 rounded bg-indigo-600 text-white text-[11px] font-semibold hover:bg-indigo-500 shadow-md shadow-indigo-500/20 transition-all flex items-center gap-1 cursor-pointer"
            >
            ...
            <button
              type="button"
              onClick={handleReset}
              className="px-2 py-1 rounded border border-slate-300 dark:border-indigo-900/60 bg-slate-50 dark:bg-indigo-950/40 text-slate-700 dark:text-slate-300 text-[11px] hover:bg-slate-100 dark:hover:bg-indigo-900/60 transition-all flex items-center gap-1 cursor-pointer"
            >
          ...
          <div className="p-3 rounded bg-amber-50/90 dark:bg-amber-950/30 border border-amber-300 dark:border-amber-500/50 text-amber-900 dark:text-amber-200 space-y-2 animate-pulse">
            ...
            <div className="pt-1">
              <button
                ...
                className="px-3 py-1.5 rounded bg-amber-500 text-black font-bold text-xs hover:bg-amber-400 shadow-md shadow-amber-500/20 transition-all flex items-center gap-1.5 cursor-pointer"
              >
