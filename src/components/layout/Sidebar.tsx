...
import { LayoutDashboard, Sparkles, Play, GitCompare, CheckSquare, Wrench, LogOut } from "lucide-react";
      ...
      <aside className="w-64 border-r border-indigo-900/40 bg-black/60 flex flex-col justify-between p-4 min-h-[calc(100vh-5.5rem)] font-mono">
        ...
        <div className="space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-3 py-2.5 rounded border border-red-500/30 bg-red-950/20 text-xs font-mono text-red-300 hover:border-red-400/60 hover:bg-red-950/40 hover:text-red-200 transition-all duration-150 cursor-pointer"
          >
